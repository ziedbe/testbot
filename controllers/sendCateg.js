...
exports.sendParrains = function(senderId, message,FACEBOOK_ACCESS_TOKEN){
    return request({
                ...
                attachment: {
                    ...
                    payload: {
                        ...
                        },
                        {
                            ...
                            title: "Cognira",
                            image_url: "https://lh4.googleusercontent.com/VDmMkFNHniM-fEsSthMX94oSRHjODMnA2nmp6fxzfjuV4qOCX7NifCWrqq0KiGtAJuZ27A76J1m1vdY=w1366-h677-rw",
...
exports.sendPartenaires = function(senderId, message,FACEBOOK_ACCESS_TOKEN){
    return request({
        url: 'https://graph.facebook.com/v2.6/me/messages',
        qs: {access_token: FACEBOOK_ACCESS_TOKEN},
        method: 'POST',
...
exports.sendCollaborateurs = function(senderId, message,FACEBOOK_ACCESS_TOKEN){
    return request({
        url: 'https://graph.facebook.com/v2.6/me/messages',
        qs: {access_token: FACEBOOK_ACCESS_TOKEN},
        method: 'POST',
                ...
                attachment: {
                    ...
                    payload: {
                        ...
                        elements: [{
                            ...
                            subtitle: "Partenaire de vos Projets Informatiques et Analytiques",
                            buttons: [
                            {
                            type: "postback",
                            title: "Description",
